        ...
        <Card className="p-6">
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <div className="text-2xl font-bold text-blue-600">{formatPrice(client.totalSpent)}</div>
            </div>
            <div>
              <div className="text-sm text-gray-500">Средний чек</div>
              <div className="text-xl font-semibold">
                {client.totalOrders > 0 ? formatPrice(client.totalSpent / client.totalOrders) : '0 ₽'}
              </div>
            </div>
          </div>
        </Card>
