...
router.post('/public', orderLimiter, requireInternalApiKey, validateSaleItems, createPublicOrder as any);
router.put('/internal/:id/full', orderLimiter, requireInternalApiKey, validateSaleItems, updateFullOrder as any);
...
router.post('/', managerAccess as any, validateSaleItems, createSaleDocument as any);
router.put('/:id', managerAccess as any, updateSaleDocument as any);
router.put('/:id/full', managerAccess as any, validateSaleItems, updateFullOrder as any);
